...
export const eternityUpgrades = {
  ...
  tdMultRealTime: {
    ...
    description: () => (Pelle.isDoomed
      ...
      : `Time Dimensions are multiplied by days played${reversionTimeText()}`
    ),
    effect: () => (Pelle.isDoomed ? Time.thisReality.totalDays.add(1) : Decimal.max(Time.thisReversion.totalDays, 1)),
    formatEffect: value => formatX(value, 2, 1)
  }
};
